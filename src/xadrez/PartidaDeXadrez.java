...
public class PartidaDeXadrez {
	...
	private void inicioDePartida() {
		posicionarNovaPeca('h', 7, new Torre(tabuleiro, Cor.BRANCA));
		posicionarNovaPeca('d', 1, new Torre(tabuleiro, Cor.BRANCA));
		posicionarNovaPeca('e', 1, new Rei(tabuleiro, Cor.BRANCA));
		
		posicionarNovaPeca('b', 8, new Torre(tabuleiro, Cor.PRETA));
		posicionarNovaPeca('a', 8, new Rei(tabuleiro, Cor.PRETA));
	}
}
